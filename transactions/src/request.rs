...
mod tests {
    ...
    fn decode_known_rlp_goerli() {
        let tx = TransactionRequest::new()
            .nonce(70272)
            .from(
                "fab2b4b677a4e104759d378ea25504862150256e"
                    .parse::<Address>()
                    .unwrap(),
            )
            .to("d1f23226fb4d2b7d2f3bcdd99381b038de705a64"
                .parse::<Address>()
                .unwrap())
            .value(0)
        ...
        let (got_tx, _signature) =
            TransactionRequest::decode_signed_rlp(&Rlp::new(&expected_rlp))
                .unwrap();
    ...
    fn test_eip155_encode() {
        ...
        let expected_sighash = hex::decode(
    ...
    fn test_eip155_decode() {
        ...
        let decoded_transaction =
            TransactionRequest::decode(&expected_rlp).unwrap();
    ...
    fn test_eip155_decode_signed() {
        ...
        let expected_signed_rlp =
            rlp::Rlp::new(expected_signed_bytes.as_slice());
