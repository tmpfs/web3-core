...
impl Signature {
        ...
        M: Into<RecoveryMessage>,
    {
        ...
        let verify_key = recoverable_sig.recover_verify_key_from_digest_bytes(
    ...
    fn as_signature(
        &self,
    ) -> Result<(RecoverableSignature, RecoveryId), SignatureError> {
        ...
        let signature = {
            ...
            let gar: &GenericArray<u8, U32> =
                GenericArray::from_slice(&r_bytes);
            let gas: &GenericArray<u8, U32> =
                GenericArray::from_slice(&s_bytes);
...
mod tests {
    ...
    fn recover_web3_signature() {
        ...
        assert_eq!(
            ...
            Address::from_str("2c7536E3605D9C16a7a3D7b1898e529396a65c23")
                .unwrap()
        );
    }
